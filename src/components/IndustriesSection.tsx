        ...
        <div className="max-w-md mx-auto mb-12 relative">
          ...
          {industrySearch && (
            <button 
              ...
              className="absolute inset-y-0 right-0 pr-4 flex items-center text-xs font-bold text-slate-400 hover:text-indigo-600 cursor-pointer focus:outline-none"
            >
              Clear
            </button>
          )}
          ...
          {filteredIndustries.length > 0 ? (
            filteredIndustries.map((ind, idx) => (
              <motion.div 
                layout
                key={ind.name}
                className="bg-white border border-slate-200/70 rounded-2xl p-6 shadow-sm hover:border-indigo-100 transition-all duration-300"
              >
                ...
                <button
                  ...
                  className="mt-4 text-[11px] font-bold text-indigo-600 hover:text-indigo-700 hover:underline transition-all block text-left cursor-pointer focus:outline-none"
                >
            ...
            <div className="col-span-full py-12 text-center text-slate-500 font-medium">
              ...
              <button 
                ...
                className="block text-indigo-600 underline font-bold text-sm mt-3 mx-auto cursor-pointer focus:outline-none"
              >
